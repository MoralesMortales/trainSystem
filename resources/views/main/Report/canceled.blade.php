            ...
            <div class="box tw:overflow-x-hidden md:tw:w-8/12 tw:h-auto tw:min-h-[70vh] tw:bg-gray-200 tw:bg-opacity-80 tw:rounded-lg tw:p-6 tw:shadow-lg tw:flex tw:flex-col">
                <div class="tw:flex-grow">
                    <div class="tw:flex tw:justify-between tw:items-center tw:mb-4">
                        ...
                        <div class="tw:relative tw:flex tw:items-center">
                            <label for="totalAmount" class="tw:mr-2 tw:text-lg tw:font-semibold">Class:</label>
                            <select id="citySelect" class="tw:block tw:bg-white tw:border tw:border-gray-400 tw:text-gray-800 tw:px-3 tw:rounded tw:shadow leading-tight focus:tw:outline-none focus:tw:shadow-outline">
                                <option value="">Seleccione</option>
                                <option value="">Normal</option>
                                <option value="">Turist</option>
