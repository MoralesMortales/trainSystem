                ...
                <div class="tw:flex-grow">
                    <div class="tw:flex tw:justify-between tw:items-center tw:mb-4">
                        ...
                        <div class="tw:relative tw:flex tw:items-center">
                            <label for="totalAmount" class="tw:mr-2 tw:text-center tw:text-lg tw:font-semibold">City:</label>
                    ...
                    <table class="tw:min-w-full tw:bg-gray-300 tw:rounded-lg tw:shadow-md tw:overflow-hidden">
                        <thead class="tw:bg-gray-400 tw:text-gray-800 tw:uppercase tw:text-sm tw:leading-normal">
                            <tr>
                                ...
                                <th class="tw:py-3 tw:px-6 tw:text-left">Origin City</th>
                                <th class="tw:py-3 tw:px-6 tw:text-left">Destiny City</th>
                                <th class="tw:py-3 tw:px-6 tw:text-left">Nro Pasengers</th>
                                <th class="tw:py-3 tw:px-6 tw:text-left">Cost</th>
                            </tr>
                        </thead>
