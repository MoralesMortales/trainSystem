                            ...
                            <tbody id="personRowsContainer">
                                <tr class="person-row">
                                    <td class="tw:text-center">
                                        <label for="statusSelect" class="tw:w-32">Gemini 1</label>
                                    </td>
                                    <td class="tw:text-center">
                                        <label for="statusSelect" class="tw:w-32">Gemini 2</label>
                                    </td> 
                                    <td class="tw:text-center">
                                        <label for="statusSelect" class="tw:w-32">Departure</label>
                                    </td>
                                    <td class="tw:text-center">
                        ...
                        <table class="tw:min-w-full tw:bg-gray-300 tw:shadow-md tw:overflow-hidden" name="Tabla de Reservas">
                            ...
                            <tbody id="personRowsContainer" class="tw:text-center">
                                <tr class="person-row">
                                    ...
                                    <td class="tw:text-center">
                                        <label for="statusSelect" class="tw:w-32">A113</label>
                                    </td>
                                    <td class="tw:text-center">
